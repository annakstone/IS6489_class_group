...
The goal of this project is to create a model to predict house prices in Ames, Iowa. This training data consists of 1,460 observations and contains 79 explanatory variables. The predictive model will focus on 13 variables.  combining the predictors with a mixture of additive and interactions methods. 
